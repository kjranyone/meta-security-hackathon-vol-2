...
**創発的な洞察（seed=42, 36tick、実ログ）**: ホルムズ封鎖のエネルギー価格は1.22にとどまる（t20以降に核融合・宇宙太陽光が普及し、**未来技術が海峡ショックを吸収**する）。一方 `earth_ban_fusion`シナリオで神が核融合を禁じてから封鎖するとエネルギー価格は**1.34**まで跳ね上がる — **未来エネルギー技術の禁止は海峡依存を固定化する**。未来予測と地政学の相互作用そのものを観測できる。
