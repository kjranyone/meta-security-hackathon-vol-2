...
|---|---|---|---|
| 世界GDP | 122.5 | **125.5** | **+2.5%** |
| デフォルト累計 | 8 | **8** | ±0（破綻は外貨建て国に集中） |
| 平均債務対GDP | 105% | **123%** | +18pt |
| 平均安定度 | 52.0 | **52.0** | ±0 |

- **全カ国学習AI化は危機対応を劇的に改善**: GDP+2.5%・債務+18ptを避ける —
  generalist戦術AIは封鎖下の債務規律（heuristicより18pt少ない債務蓄積）を学習している
  （Q1+Q2の「学習AIは抑止構造が強いほど安定化する」結果と整合）
