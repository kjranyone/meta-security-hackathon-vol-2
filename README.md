...
| 現状（9カ国保有） | 108.7±11.5 件 | 72.0±5.0 件 | 117.3±6.3 件 | t4 / t4（GLM t5） |
...
- **思考AI（z.ai GLM、3seed×72ヶ月）: 戦争 117.3±6.3 件・初回開戦 t5** — ルールAI(t4)より
  開戦が**遅い**（協調的な外交判断が危機の起点を遅らせる）。戦争数は同等。
  LLMは非決定論で高コストのため予備的観察として扱う
